...
import { SITE_ICON } from "../../Global/Constants";
  ...
  const runValidations = () => {
    ...
    if (!checkPasswordStrength(formState.password.value)) {
      setFormState((prev) => {
        ...
        errorState.password.error = true;
        return errorState;
      });
      failed = true;
    }
    ...
    >
      <Paper sx={authStyles.loginWrapper}>
        <Box sx={authStyles.header}>
          ...
          <Typography sx={authStyles.loginTitle}>Sign In to Bookery</Typography>
        </Box>
